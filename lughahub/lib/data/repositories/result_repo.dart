...
class ResultRepo {
  ...
  Future<QuerySnapshot<Object?>> getLastTenScores(String category, String diffLevel) async {
    final CollectionReference scores = FirebaseFirestore.instance.collection('score');
    return scores.where('userId', isEqualTo: FirebaseAuth.instance.currentUser!.uid)
